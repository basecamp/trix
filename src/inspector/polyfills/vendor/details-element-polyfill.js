    ...
    ;(i = {
        ...
        return (
          ...
          "open" in e
            ? ((e.innerHTML = "<summary>a</summary>b"),
              ...
              (r = null != (o = document.body) ? o : document.documentElement),
              r.appendChild(e),
              (t = e.offsetHeight),
              (e.open = !0),
              (n = e.offsetHeight),
      ...
      (i.element && i.toggleEvent) ||
        ...
        (n = function() {
          var t, e, n, r, o
          return (
            (t = document.createElement("details").constructor.prototype),
            (r = t.setAttribute),
            (n = t.removeAttribute),
            (o = null != (e = Object.getOwnPropertyDescriptor(t, "open")) ? e.set : void 0),
            Object.defineProperties(t, {
              open: {
                set: function(t) {
                  return "DETAILS" === this.tagName
                    ? (t ? this.setAttribute("open", "") : this.removeAttribute("open"), t)
                    : null != o
                    ? o.call(this, t)
                    : void 0
                },
        ...
        (u = function() {
          var t
          return "undefined" != typeof MutationObserver && null !== MutationObserver
            ? ((t = new MutationObserver(function(t) {
                ...
                for (u = [], n = 0, r = t.length; r > n; n++)
                  (o = t[n]),
                    (i = o.target),
                    (e = o.attributeName),
                    "DETAILS" === i.tagName && "open" === e ? u.push(a(i)) : u.push(void 0)
                return u
              })),
              t.observe(document.documentElement, { attributes: !0, subtree: !0 }))
            : e(function(t) {
                var e
                return (
                  (e = t.getAttribute("open")),
                  setTimeout(function() {
                    return t.getAttribute("open") !== e ? a(t) : void 0
                  }, 1)
                )
              })
        }),
          ...
          return addEventListener(
            ...
            function(n) {
              ...
              return t(n) &&
                ...
                (u = o.tagName),
                (r = o.parentElement),
                "SUMMARY" === u && "DETAILS" === (null != r ? r.tagName : void 0))
                ? e(r)
                : void 0
            },
            !1
        ...
        (l = function(t, e) {
          var n, r
          return (n = t.getAttribute("open")), (r = e()), t.getAttribute("open") !== n && a(t), r
        }),
        i.element || (r(), n(), o()),
        i.element && !i.toggleEvent && u())
  }.call(this),
  function() {}.call(this))
